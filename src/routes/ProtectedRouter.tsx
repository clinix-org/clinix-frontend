...
const SessionLoading = () => (
  <main className='flex min-h-screen items-center justify-center bg-[#f4f4f5] px-4'>
    ...
    >
      ...
      <h1 className='text-base font-semibold text-[#3f464d]'>
        Validando Sessão
      </h1>
      <p className='mt-2 text-sm text-[#646b72]'>
...
const TemporaryUnavailable = () => (
  <main className='flex min-h-screen items-center justify-center bg-[#f4f4f5] px-4'>
    <section className='w-full max-w-[420px] rounded-lg bg-white p-6 text-center shadow-sm'>
      <h1 className='text-lg font-semibold text-[#3f464d]'>
        Serviço temporariamente indisponível
      </h1>
      <p className='mt-2 text-sm leading-6 text-[#646b72]'>
        Não foi possível validar sua sessão agora. Tente entrar novamente em
        instantes.
      </p>
      <a
        href='/login'
